...
<body>
    ...
    <section class="food">
        <div class="food-moto">
            <h1>FOOD</h1>
            <p>We make lovely comfort food that is easy to share, using the season’s products.Whoever shares, gets more! This is the logic behind our kitchen door.</p>
        </div>
    </section>
        ...
        <div class="christmas-menu-1st-2nd">
            <img class="cod-image" src="" alt="Cod with beetroot & blackberry">
            <div class="1st-2nd-text">
                <h3> 1st serving </h3>
                <p>Cod with beetroot & blackberry Dab with kohlrabi & apple Scallop with cucumber & cream (Caviar +55)</p>
                <h3> 2nd serving </h3>
                <p>Grilled brioche, duck confit & red cabbage Pommes Rôsti with sour cream & chives (Truffles +55) Veal schnitzel with chantarelles-remoulade & baby sprouts</p>
            </div>
        </div>
        <div class="christmas-menu-3rd-4th">
            <img class="leek-image" src="" alt="Leek with truffle & hazelnuts">
            <div class="3rd-4th-text">
                <h3> 3rd serving </h3>
                <p>Leek, caramelized butter & roasted hazelnuts Hokkaido pumpkin & butternut squash Breast of pork with lingon berries & puffed pork rind(Opgr. Black Angus with sauce bordelais & pommes frites +125)</p>
                <h3> 4th serving </h3>
